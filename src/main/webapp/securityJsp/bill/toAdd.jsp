...
<head>
    ...
    <script type="text/javascript">
         ...
         */
        function checkform() {
            if (checkmoney() && checkunit() && checkamount() && checkproductName() && checksname() && checkisPay()) {
                return true;
            }
            return false;
        }
            ...
            <table class="box">
                ...
                <tr>
                    ...
                    <td><input type="text" name="productName" id="productName"
                               class="text" onblur="return checkproductName();"/> <span
                            id="sproductName" style="color: red; font-size: 12px"></span></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><select id="isPay" name="isPay"
                                onblur="return checkisPay();">
                        <option value="" selected="selected">请选择</option>
                        <option value="1">是</option>
                        <option value="0">否</option>
                    </select> <span id="iisPay" style="color: red; font-size: 12px"></span></td>
                </tr>
            </table>
        </div>
        <div class="buttons">
