        ...
        <tr>
            <td>
                <form method="post" action="supplier_list.action">
                    供应商名称： <input name="sname" placeholder="请输入供应商名称" class="input-text" type="text"/>&nbsp;
                    供应商描述：<input name="description" placeholder="请输入供应商描述" class="input-text" type="text"/> &nbsp;&nbsp;&nbsp;&nbsp;
...
<div class="main">
    <div class="optitle clearfix">
        <em> <input value="添加数据" class="input-button" onclick="window.location='supplier_toAdd.action'" type="button"/>
        </em>
    ...
    <div class="content">
        <table class="list">
            ...
            <c:forEach var="suppliers" items="${supplierList.records}" varStatus="vars">
                <tr>
                    <td width="70" height="29">
                        <div class="STYLE1" align="center">${pager.offset + vars.count}</div>
                    </td>
                    <td width="80">
                    ...
                    <td width="100">
                        <div class="STYLE1" align="center">
                            <input type="button" value="修改"
                                   onclick="window.location.href='supplier_toUpdate.action?id=${suppliers.sid}'"/>
            ...
            <tr>
                <td colspan="7">
                    <jsp:include page="../inc/pager.jsp">
                        ...
                        <jsp:param value="${supplierList.total }" name="items"/>
