				...
				<table class="box">
					...
					<tbody>
						<tr>
							...
							<td><input name="sid" type="hidden"
								value="${requestScope.supplier.sid}" /> <input name="sname"
								id="sname" value="${requestScope.supplier.sname}" class="text"
								type="text" onblur="return checksname();" /> <span id="ssname"
								style="color: red; font-size: 12px"></span></td>
						</tr>
						<tr>
							<td class="field">供应商描述：</td>
							<td><textarea name="description" id="description" cols="45"
									rows="5">${requestScope.supplier.description}</textarea></td>
						</tr>
						<tr>
							<td class="field">供应商联系：</td>

							<td><input name="contacter" id="contacter"
								value="${requestScope.supplier.contacter}" class="text"
								type="text" /></td>
						</tr>
						<tr>
							<td class="field">供应商电话：</td>
							<td><input name="phone" id="phone"
								value="${requestScope.supplier.phone}" class="text" type="text" />
							</td>
						</tr>
						<tr>
							...
							<td><input name="fax" id="fax"
								value="${requestScope.supplier.fax}" class="text" type="text" />
							</td>
						</tr>
						<tr>
							<td class="field">供应商地址：</td>
							<td><input name="address" id="address"
								value="${requestScope.supplier.address}" class="text"
								type="text" /></td>
						</tr>
					</tbody>
				</table>
