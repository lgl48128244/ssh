...
<body>
	<div class="main">
		...
		<form id="form1" name="form1" method="post"
			action="user_updatePWD.action"
			onsubmit="return checkform();">
			<div class="content">
				<table class="box">
					<tr>
						<td class="field">旧的密码：</td>
						<td><input type="hidden" id="pwd"
							value="${sessionScope.user.password}" /> <input type="hidden"
							name="upk" value="${sessionScope.user.upk}" /> <input
							type="password" name="oldpassword" class="text" id="oldpassword"
							onblur="return checkoldpassword();" /> <span id="soldpassword"
			...
			<div class="buttons">
				<input type="button" name="button" value="返回" class="input-button"
					onclick="history.back();" /> <input type="submit" value="修改密码"
					class="input-button" />
			</div>
		</form>
	</div>
